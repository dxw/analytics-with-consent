    ...
    describe('->enqueueScripts()', function () {
        ...
        context('Civic Cookie API Key is set', function () {
            ...
            context('and Civic Product Type is set', function () {
                it('enqueues the Civic Cookie Control script and the config script', function () {
                    ...
                    allow('plugins_url')->toBeCalled()->andReturn('http://path/to/this/plugin/static/js/config.js');
                    expect('plugins_url')->toBeCalled()->once()->with('/static/js/config.js', '/path/to/this/plugin');
                    expect('wp_enqueue_script')->toBeCalled()->once()->with('civicCookieControlConfig', 'http://path/to/this/plugin/static/js/config.js', ['civicCookieControl']);
                    $this->scripts->enqueueScripts();
                });
            });
        });
